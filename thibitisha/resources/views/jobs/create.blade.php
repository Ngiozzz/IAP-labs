        ...
        <div class="bg-white shadow-sm rounded p-6">
            ...
            <form action="{{ route('jobs.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="queue" value="{{ old('queue') }}" 
                ...
                <div class="mb-3">
                    ...
                    <textarea name="payload" rows="5" 
                              class="form-control w-full border rounded px-3 py-2" required>{{ old('payload') }}</textarea>
                </div>

                <div class="mb-3">
                    <label class="block text-gray-700 font-medium mb-1">Attempts</label>
                    <input type="number" name="attempts" value="{{ old('attempts', 0) }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="available_at" value="{{ old('available_at') }}" 
                           class="form-control w-full border rounded px-3 py-2" required>
                </div>
